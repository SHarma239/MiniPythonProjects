'''
Created for MiniPythonProjects Repository
...
abbreviations = open("chatacronyms.txt",'w')
abbreviations.write(toappend.encode('utf-8').strip())
abbreviations.close()

# One or two elements had to be fixed manually for the program to work correctly. Use the chatacronyms.txt file to get the correct results. 
#This scraper is going to generate chatacronyms.txt which will have most of the data
